...
// ------------------COMPONENT FUNCTION-------------------------
const NoteList: React.FC<NoteProps> = ({ availableTags, notes, onUpdateTag, onDeleteTag }) => {
  ...
  return (
    <>
      <Row className="align-items-center mb-4">
        ...
        <Col xs="auto">
          <Stack direction="horizontal" gap={2}>
            ...
            <Button variant="outline-secondary" onClick={() => setEditTagsModal(true)}>Edit Tags</Button>
          </Stack>
        </Col>
      </Row>
      <Form className="mb-4">
      ...
      <EditTagsModal availableTags={availableTags} show={editTagsModal} handleClose={() => setEditTagsModal(false)} onUpdateTag={onUpdateTag} onDeleteTag={onDeleteTag}/>
    </>
  );
};
